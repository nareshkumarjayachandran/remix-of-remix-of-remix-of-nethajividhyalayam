...
const TOPIC_SUGGESTIONS_MAP: Record<string, string[]> = {
  ...
  // ══════════════════════════════════════════════════════
  "SK-Term 1-Pre-KG-Hindi":  ["अ, आ (स्वर)", "गिनती 1-3", "मेरा नाम"],
  "SK-Term 2-Pre-KG-Hindi":  ["इ, ई, उ (स्वर)", "रंग", "फल"],
  "SK-Term 3-Pre-KG-Hindi":  ["ऊ, ए, ऐ (स्वर)", "जानवर", "मेरा शरीर"],
  "SK-Term 1-LKG-Hindi":     ["स्वर (अ-औ)", "गिनती 1-10", "मेरा परिवार"],
  "SK-Term 2-LKG-Hindi":     ["व्यंजन (क-ङ)", "फल और सब्जियाँ", "रंग और आकार"],
  "SK-Term 3-LKG-Hindi":     ["व्यंजन (च-ञ)", "जानवर", "मेरा विद्यालय"],
  "SK-Term 1-UKG-Hindi":     ["व्यंजन (ट-प)", "सरल शब्द पढ़ो", "मेरा घर"],
  "SK-Term 2-UKG-Hindi":     ["व्यंजन (फ-ह)", "दो अक्षर के शब्द", "शरीर के अंग"],
  "SK-Term 3-UKG-Hindi":     ["मात्राएँ (आ, इ)", "सरल वाक्य", "त्योहार"],
  "MB-Term 1-Pre-KG-Hindi":  ["अ, आ (स्वर)", "गिनती 1-3", "मेरा नाम"],
  "MB-Term 2-Pre-KG-Hindi":  ["इ, ई, उ (स्वर)", "रंग", "फल"],
  "MB-Term 3-Pre-KG-Hindi":  ["ऊ, ए, ऐ (स्वर)", "जानवर", "मेरा शरीर"],
  "MB-Term 1-LKG-Hindi":     ["स्वर (अ-औ)", "गिनती 1-10", "मेरा परिवार"],
  "MB-Term 2-LKG-Hindi":     ["व्यंजन (क-ङ)", "फल और सब्जियाँ", "रंग और आकार"],
  "MB-Term 3-LKG-Hindi":     ["व्यंजन (च-ञ)", "जानवर", "मेरा विद्यालय"],
  "MB-Term 1-UKG-Hindi":     ["व्यंजन (ट-प)", "सरल शब्द पढ़ो", "मेरा घर"],
  "MB-Term 2-UKG-Hindi":     ["व्यंजन (फ-ह)", "दो अक्षर के शब्द", "शरीर के अंग"],
  "MB-Term 3-UKG-Hindi":     ["मात्राएँ (आ, इ)", "सरल वाक्य", "त्योहार"],
};
