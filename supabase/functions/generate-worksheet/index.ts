  ...
  try {
    ...
    const langInstruction =
      language === "Tamil"
        ...
        : language === "Bilingual"
        ? `FULLY BILINGUAL (${biLang1} + ${biLang2}): STRUCTURE: Write the COMPLETE ${biLang1} text FIRST, then " / ", then the COMPLETE ${biLang2} translation. LEFT of "/" is ALWAYS ${biLang1}. RIGHT of "/" is ALWAYS ${biLang2}. ${biLang1 === "Tamil" && biLang2 === "Hindi" ? `CORRECT: "என் நண்பன் தினமும் பள்ளிக்குச் செல்கிறான். / मेरा दोस्त हर दिन स्कूल जाता है।" and "சூரியன் / सूरज" and "நிலா / चाँद". WRONG: "What gives us light? / நமக்கு ஒளி தருவது எது?" — this is English/Tamil but you need Tamil/Hindi!` : biLang1 === "English" ? `CORRECT: "My friend goes to school. / ${biLang2 === "Tamil" ? "என் நண்பன் பள்ளிக்குச் செல்கிறான்." : "मेरा दोस्त स्कूल जाता है।"}" and "Sun / ${biLang2 === "Tamil" ? "சூரியன்" : "सूरज"}". WRONG: Both sides in same language.` : `CORRECT: "${biLang1} text / ${biLang2} translation". WRONG: Both sides in same language.`} MCQ options: DO NOT include a) b) c) d) prefixes — system adds them. TRANSLATION: Google Translate-level accuracy. Natural, grammatically perfect ${biLang2}. No labels like "English:" or "தமிழ்:" anywhere.`
