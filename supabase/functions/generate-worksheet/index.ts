  ...
  try {
    ...
    const langInstruction =
      language === "Tamil"
        ...
        : language === "Bilingual"
        ? `FULLY BILINGUAL (${biLang1} + ${biLang2}): STRUCTURE: Write the COMPLETE ${biLang1} text FIRST, then " / ", then the COMPLETE ${biLang2} translation. LEFT of "/" is ALWAYS ${biLang1}. RIGHT of "/" is ALWAYS ${biLang2}. CORRECT EXAMPLES: "My friend goes to school every day. / என் நண்பன் தினமும் பள்ளிக்குச் செல்கிறான்." and "The _______ shines brightly. / _______ பிரகாசமாக ஒளிர்கிறது." and "a) Apple / ஆப்பிள்". WRONG (NEVER DO): "நண்பன் / நண்பன் வந்தான்" — both sides are ${biLang2}! LEFT must be ${biLang1}. TRANSLATION QUALITY — CRITICAL: You MUST translate with the accuracy and fluency of Google Translate or better. Use the most natural, grammatically perfect ${biLang2} phrasing that a native ${biLang2} speaker would instantly recognize as correct. For Tamil: use proper சொற்கள் (words), correct விகுதிகள் (suffixes), and natural sentence structure — NOT literal word-by-word translation. For example: "Fill in the blanks" = "கோடிட்ட இடங்களை நிரப்புக" (NOT "வெற்றிடங்களை நிரப்பு"). "Choose the correct answer" = "சரியான விடையைத் தேர்ந்தெடுக்கவும்" (NOT "சரியான பதிலை தேர்ந்தெடு"). Every translated word must be dictionary-accurate and contextually appropriate. No language labels like "English:" or "தமிழ்:" anywhere.`
